...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ThatsTheLabor Core thatsthelabor-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  thatsthelabor-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thatsthelabor transaction") + "\n" +
                               "  thatsthelabor-tx [options] -create [commands]   " + _("Create hex-encoded thatsthelabor transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded thatsthelabor transaction
