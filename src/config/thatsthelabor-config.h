/* src/config/thatsthelabor-config.h.  Generated from thatsthelabor-config.h.in by configure.  */
/* src/config/thatsthelabor-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.thatsthelabor.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ThatsTheLabor Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ThatsTheLabor Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "thatsthelabor"
