...
/** Utility functions used by the ThatsTheLabor Qt UI.
 */
namespace GUIUtil
{
...
// Render ThatsTheLabor addresses in monospace font
...
// Parse "thatsthelabor:" URI into recipient object, return true on successful parsing
