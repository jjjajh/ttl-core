...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ThatsTheLabor [TTL] v2"),
     ...
     * override -datadir in the thatsthelabor.conf file in the default data directory
     * (to be consistent with thatsthelabord behavior)
     */
    if (dataDir != getDefaultDataDirectory())
