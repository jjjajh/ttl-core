                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ThatsTheLabor [TTL]") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ThatsTheLabor address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and thatsthelabor: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTTL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ThatsTheLabor Core"), this);
    aboutAction->setStatusTip(tr("Show information about ThatsTheLabor Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ThatsTheLabor"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ThatsTheLabor addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ThatsTheLabor addresses"));
    ...
    openAction->setStatusTip(tr("Open a ThatsTheLabor: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ThatsTheLabor Core help message to get a list with possible ThatsTheLabor command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ThatsTheLabor Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ThatsTheLabor network", "", count));
}
...
{
    QString strTitle = tr("ThatsTheLabor [TTL]"); // default title
