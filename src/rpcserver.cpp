...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ThatsTheLabor server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ThatsTheLabor server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ThatsTheLabor features */
        {"thatsthelabor", "masternode", &masternode, true, true, false},
        {"thatsthelabor", "listmasternodes", &listmasternodes, true, true, false},
        {"thatsthelabor", "getmasternodecount", &getmasternodecount, true, true, false},
        {"thatsthelabor", "masternodeconnect", &masternodeconnect, true, true, false},
        {"thatsthelabor", "masternodecurrent", &masternodecurrent, true, true, false},
        {"thatsthelabor", "masternodedebug", &masternodedebug, true, true, false},
        {"thatsthelabor", "startmasternode", &startmasternode, true, true, false},
        {"thatsthelabor", "createmasternodekey", &createmasternodekey, true, true, false},
        {"thatsthelabor", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"thatsthelabor", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"thatsthelabor", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"thatsthelabor", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"thatsthelabor", "getmasternodescores", &getmasternodescores, true, true, false},
        {"thatsthelabor", "mnbudget", &mnbudget, true, true, false},
        {"thatsthelabor", "preparebudget", &preparebudget, true, true, false},
        {"thatsthelabor", "submitbudget", &submitbudget, true, true, false},
        {"thatsthelabor", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"thatsthelabor", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"thatsthelabor", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"thatsthelabor", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"thatsthelabor", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"thatsthelabor", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"thatsthelabor", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"thatsthelabor", "checkbudgets", &checkbudgets, true, true, false},
        {"thatsthelabor", "mnsync", &mnsync, true, true, false},
        {"thatsthelabor", "spork", &spork, true, true, false},
        {"thatsthelabor", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"thatsthelabor", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use thatsthelabord, or the -server option to thatsthelabor-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> thatsthelabor-cli " + methodname + " " + args + "\n";
}
