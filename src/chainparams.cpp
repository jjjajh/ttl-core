...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04694e051a4ca94cea480840b4cd03a50b7b7a9a881baa67c248d199a022684db45b0a740370ba56693ecb91cdd5aee72f7f989c83666616eb18387c83c5e77891");
        nDefaultPort = 7070;
        ...
        nMaxMoneyOut = 100000000000000 * COIN;
        ...
        const char* pszTimestamp = "THATSTHELABOR - arrived with new era of technology.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04139989ade38806c6e8198201df0b02249d2751fd0ceb360fee06646cb6f618de03a50d620f384afde0b78861629efc1d8d24bd9d63ee3f0d8edc9d6ce5b2601d") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1604853150;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 379432;
	...
	/*if(genesis.GetHash() != uint256("0x"))
        ...
        assert(hashGenesisBlock == uint256("0x0000076f0dcc630b1a18228bcf9411fc3b0def505c3bf2ed76e1256f88f2df8e"));
        assert(genesis.hashMerkleRoot == uint256("0x993652b54b2f2f64bc274c57914c599b238a5c2bad23726f718a584e8a776d9b"));
		
		vSeeds.push_back(CDNSSeedData("161.35.63.12", "161.35.63.12"));   // Primary DNS Seeder
		vSeeds.push_back(CDNSSeedData("167.99.13.80", "167.99.13.80"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ThatsTheLabor: 1 day
        nTargetSpacing = 1 * 60;  // ThatsTheLabor: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.ttl.io", "testnet.ttl.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.ttl.io", "testnet1.ttl.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet.thatsthelaborcoin.org", "testnet.thatsthelaborcoin.org"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet thatsthelabor addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet thatsthelabor script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet thatsthelabor BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet thatsthelabor BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet thatsthelabor BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // ThatsTheLabor: 1 day
        nTargetSpacing = 1 * 60;        // ThatsTheLabor: 1 minutes
