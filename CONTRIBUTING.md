Contributing to ThatsTheLabor Core
============================

The ThatsTheLabor Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ThatsTheLabor Core project, and is not to be
confused with overall ThatsTheLabor Network Protocol consensus changes.

Whether a pull request is merged into ThatsTheLabor Core rests with the project merge
...
Patches that change ThatsTheLabor consensus rules are considerably more involved than
...
Where a patch set proposes to change the ThatsTheLabor consensus, it must have been
...
The project leader is the release manager for each ThatsTheLabor Core release.
