...
In order to support loading of multiple wallets in thatsthelabor-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is thatsthelabor.cpp.
...
Changes to thatsthelabor.cpp
----------------------
thatsthelabor.cpp is the entry point into thatsthelabor-qt, and as such, will require some minor modifications to provide hooks for
